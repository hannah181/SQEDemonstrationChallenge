...
public class DriverUtil extends CPageBase{
	...
	public static WebDriver startBrowser(String browserName) {
	    ...
	    private static WebDriver startFirefoxBrowser() {
	   	 ...
	   	 logger.info("Successfully Initiated Firefox Driver");
	   	 return driver;
	    }
	    ...
	    private static WebDriver startFirefoxBrowserInPrivateMode() {
	   	 ...
	   	 logger.info("Successfully Initiated Firefox Driver in private mode");
	   	 return driver;
	    }
	    ...
	    private static WebDriver startDockerContainerChromeBrowser() {
	   	 ...
	   	 logger.info("Successfully Initiated Chrome Driver in Docker Container");
	   	 return driver;
	    }
	    ...
	    private static WebDriver startDockerContainerFirefoxBrowser() {
	   	 ...
	   	 logger.info("Successfully Initiated Firefox Driver in Docker Container");
	   	 return driver;
	    }
	    ...
	    private static WebDriver startEdgeBrowser() {
	   	 ...
	   	 logger.info("Successfully Initiated Edge Driver");
	   	 return driver;
	    }
	    ...
	    private static WebDriver startIEBrowser() {
	   	 ...
	   	 logger.info("Successfully Initiated IE Driver");
	   	 return driver;
	    }

	    private static String getLocalDriverPath(String driverinfo) {

	   	 return "/src/test/resources/chromedriver/windows/" + driverinfo + ".exe";
